...
* `App.java`: Contiene la lógica de conexión y consulta a la base de datos.
* `script_db.sql`: Script para la creación de la base de datos `bioroute_db` y tablas de Clientes, Productos y Pedidos.# BioRoute-Logistica
